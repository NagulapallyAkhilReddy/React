...
function Home() {
  ...
  return (
    <div className='flex flex-col min-h-screen justify-center  p-3 ' style={{backgroundColor:theme==='light'?'white':'black'}}>
      ...
      <section className='pb-10' style={{color:theme==='light'?'black':'white'}}>
       ...
       <div className=' grid grid-cols-1 md:grid-cols-2  gap-8 p-2 m-6 '>
        
          
            <Link to={`/service/${webdevelopment.tjson}`} >
            <div key={webdevelopment.id} className=' flex flex-col items-center justify-start border-2 rounded-3xl overflow-hidden p-4 h-auto hover:scale-102  min-h-[500px]  ' >
              <img className='w-full max-w-[300px] md:h-[250px] h-auto rounded-2xl object-cover p-2  ' src={webdevelopment.image} alt={webdevelopment.title} />
            ...
            <div key={mobileapp.id} className=' flex flex-col items-center justify-start border-2 rounded-3xl overflow-hidden p-4 h-auto hover:scale-102  min-h-[500px]' >
              <img className='w-full max-w-[300px] md:h-[250px] h-auto rounded-2xl object-cover p-2  ' src={mobileapp.image} alt={mobileapp.title} />
            ...
            <div key={uiux.id} className=' flex flex-col items-center justify-start border-2 rounded-3xl overflow-hidden p-4 h-auto hover:scale-102  min-h-[500px]' >
              <img className='w-full max-w-[300px] md:h-[250px] h-auto rounded-2xl object-cover p-2  ' src={uiux.image} alt={uiux.title} />
            ...
            <div key={cybersecurity.id} className=' flex flex-col items-center justify-start border-2 rounded-3xl overflow-hidden p-4 h-auto hover:scale-102  min-h-[500px]' >
              <img className='w-full max-w-[300px] md:h-[250px] h-auto rounded-2xl object-cover p-2  ' src={cybersecurity.image} alt={cybersecurity.title} />
