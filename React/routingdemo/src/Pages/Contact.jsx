        ...
        <section className='mr-10 flex-col items-center h-[400px]'>
         ...
         <section className='flex flex-col gap-3'>
           <form ref={form} onSubmit={sendEmail} className='flex flex-col  justify-center'  >
            <ToastContainer />
             <input type="text" name='name' placeholder='your name' required className='rounded-2xl pl-3 mb-3' />
             <input type="email" name='email' placeholder='your email' required className='rounded-2xl pl-3 mb-3' />
              <textarea name="message" rows="5" placeholder='Your Message' required className='rounded-2xl pl-3 mb-3 h-auto w-full md:w-[300px]'  ></textarea>
